...
class ForumMemberProfile extends PageController
{
    ...
    function init()
    {
        Requirements::themedCSS('client/css/Forum', 'forum', 'all');
    ...
    function show($request)
    {
        ...
        return $this->renderWith(array('SilverStripe\Forum\Pages\ForumMemberProfile_show', 'Page'));
    }
    ...
    function edit()
    {
        $holder = DataObject::get_one(ForumHolder::class);
    ...
    function EditProfileForm()
    {
        ...
        if ($holder = DataObject::get_one(ForumHolder::class, "\"DisplaySignatures\" = '1'")) {
    ...
    function dosave($data, $form)
    {
        ...
        $forumGroup = DataObject::get_one(Group::class, "\"Code\" = 'forum-members'");
    ...
    {
        return array(
            "Form" => DataObject::get_one(ForumHolder::class)->ProfileModify
        );
    }
    ...
    function Member()
    {
        ...
        if (!empty($this->urlParams['ID']) && is_numeric($this->urlParams['ID'])) {
            $member = DataObject::get_by_id(Member::class, $this->urlParams['ID']);
        } else {
    ...
    {
        $holders = DataObject::get(ForumHolder::class);
        if ($holders) {
